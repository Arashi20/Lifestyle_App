"""Verbatim mirror of the main app's app/services/watchlist.py.

The connector deploys standalone and cannot import the main app, so the
watchlist matching and goodness score are copied here. Only the import line
differs; `python mcp/check_drift.py` fails if the two files ever diverge in
anything else, so retuning the score in the main app is caught.
"""
# --- mirrored from app/services/watchlist.py below this line ---
import re
